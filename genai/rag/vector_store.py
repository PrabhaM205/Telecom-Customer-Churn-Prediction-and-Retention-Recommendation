...
# --------------------------------------------------
# Paths -- resolved against PROJECT ROOT, not cwd (see src/config.py)
# --------------------------------------------------

PDF_PATH = str(resolve_path(get("rag", "pdf_path", default="data/raw/company_policy.pdf")))
VECTOR_DIR = str(resolve_path(get("rag", "vector_dir", default="data/processed/policy_vector_store")))

INDEX_PATH = os.path.join(VECTOR_DIR, "policy.index")
